...
export default function Skills() {
	...
	return (
		<section className="flex flex-col items-center bg-oddBg px-9 tablet:px-[158px] py-[70px] mobile:py-[35px] space-y-[70px] mobile:space-y-[35px]">
			<h2 className="text-5xl font-black mobile:text-3xl">SKILLS</h2>
			<div className="w-[831px] tablet:w-full tablet:min-w-[520px] mobile:w-[200px] flex flex-wrap justify-around">
					...
					<DescriptionCard size="skills" key={logo + idx.toString()}>
						...
						<div className="w-full h-[120px] overflow-auto mobile:hidden">
							<p className="text-nav font-medium">
								...
								아시겠죠?asdfasdfsdafsd ㅁㅇㄴㄹㄴㅁㅇㄹㄴㅁㅇㄹㅁㅇㄴ
							</p>
						</div>
					</DescriptionCard>
				))}
